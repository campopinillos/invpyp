...
tab1_content = html.Div([
    ...
    html.Div([
        ...
        html.Br(),
        html.Div(id="collapse-output-fis")]),
    html.Hr(),
    html.Div(id='output-data-upload-tab1-fis'),
...
tab2_content = html.Div([
    ...
    html.Div(id="output"),
    html.Div(id='output-data-upload-tab2-fis'),
    dash_table.DataTable(
        id='data-table-tab2',
        columns=[],  # Se actualizará en la función display_contents
        data=[],     # Se actualizará en la función display_contents
...
@callback(
    Output("collapse-output-fis", "children"),
...
@callback(Output('output-data-upload-tab1-fis', 'children'),
              Output('data-table-fis', 'columns'),
              Output('data-table-fis', 'data'),
...
# Función para mostrar los datos en la interfaz de usuario
@callback(
    Output('output-data-upload-tab2-fis', 'children'),
    Input("input1", "value"),
    Input("input2", "value"),
    Input("input3", "value"),
